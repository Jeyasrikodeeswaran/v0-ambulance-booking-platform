  ...
  const validateForm = () => {
    ...
    if (!formData.vehicleNumber.trim()) {
      ...
      const duplicate = existingAmbulances.find(
        (a) => a.vehicleNumber.toLowerCase() === formData.vehicleNumber.toLowerCase()
      )
      if (duplicate) {
        ...
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription>Enter the details of your ambulance</CardDescription>
            </div>
          </div>
        </CardHeader>
        <CardContent>
